...
import io.almayce.dev.icologs.databinding.FragmentActiveBinding
import io.almayce.dev.icologs.presenter.ActivePresenter
...
class ActiveFragment : MvpAppCompatFragment(), ActiveView, ActiveRecyclerViewAdapter.ItemClickListener {

    @InjectPresenter
    lateinit var pr: ActivePresenter
    private lateinit var bn: FragmentActiveBinding

    override fun onCreateView(inflater: LayoutInflater?, @Nullable container: ViewGroup?, @Nullable savedInstanceState: Bundle?): View? {
        bn = DataBindingUtil.inflate<FragmentActiveBinding>(
                inflater, R.layout.fragment_active, container, false)
        pr.init(context)
